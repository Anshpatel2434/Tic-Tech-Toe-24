...
const PostFile = () => {
    ...
    const options = [
        "Fiction","Mystery","Thriller","Science Fiction","Fantasy","Historical","Biography","Self-Help","Romance","Horror","Adventure","Philosophy","Children's","Young Adult","Poetry","Graphic Novel","Drama","Humor","Spirituality","Education","Health","Business","Travel","Cooking","Art","History","Science","Religion","Sports","Technology"
      ];
			...
			<div className="w-full max-w-lg p-8 bg-[#11101d] shadow-2xl rounded-lg border border-[#2e2c4e]">
				...
				<form onSubmit={sendRequest} className="space-y-6">
					...
					<div className="relative" ref={dropdownRef}>
                        ...
                        {isDropdownOpen && (
                            <div className="absolute w-full mt-1 h-20 overflow-x-auto  bg-[#1d1b31] border-2 border-[#2e2c4e] rounded-md">
                            {options.map((option) => (
                                <div key={option} className="px-3 py-2">
                        ...
                        <div >
                            <div >
                                <label 
                                htmlFor="file" className="block text-sm font-medium text-gray-400 mb-2">
                                    Choose File : 
                                </label>
                                <input
                                type="file"
